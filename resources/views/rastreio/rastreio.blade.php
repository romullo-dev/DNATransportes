                    ...
                    <div class="card-header d-flex justify-content-between align-items-center"
                        ...
                        @php
                            ...
                            $badgeClass = match ($status) {
                                ...
                                'CANCELADO' => 'bg-danger',
                                'EM PROCESSAMENTO' => 'bg-dark text-light',

                                default => 'bg-secondary text-light',
                            };
                        @endphp

                        <span class="badge {{ $badgeClass }} fw-semibold px-3 py-2 shadow-sm">
                            {{ $status }}
                        </span>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="bg-black rounded-3 p-3 shadow-sm">
                                    ...
                                    <span
                                        class="fw-bold text-light">{{ \Carbon\Carbon::parse($pedido->created_at)->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="bg-black rounded-3 p-3 shadow-sm border-start border-3 border-warning">
                                    <h6 class="fw-bold text-warning mb-2"><i class="bi bi-person-fill me-1"></i> Remetente
                                    </h6>
                            ...
                            <div class="col-md-6">
                                <div class="bg-black rounded-3 p-3 shadow-sm border-start border-3 border-warning">
                                    <h6 class="fw-bold text-warning mb-2"><i class="bi bi-house-fill me-1"></i> Destinatário
                                    </h6>
                                    <p class="mb-1"><i class="bi bi-person-badge text-secondary me-1"></i>
