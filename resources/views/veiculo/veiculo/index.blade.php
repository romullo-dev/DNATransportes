...
@section('content')
    ...
    <div class="container-fluid py-5" style="background-color: #12181F; min-height: 100vh; color: #f1f1f1;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-warning fw-semibold rounded-pill px-4 shadow-sm" data-bs-toggle="modal"
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <button class="btn btn-sm btn-outline-warning rounded-circle" data-bs-toggle="modal"
                                            data-bs-target="#modalShow{{ $veiculo->id_Veiculo }}">
                                            <i class="bi bi-eye-fill"></i>
                                        </button>

                                        <button class="btn btn-sm btn-outline-info rounded-circle" data-bs-toggle="modal"
                                            data-bs-target="#modalEdit{{ $veiculo->id_Veiculo }}">
        ...
        @include('veiculo.veiculo.modais.show')
        @include('veiculo.veiculo.modais.edit')
